...
import numpy as np
from RespFeatureExtractor.htsat.htsat import HTSATWrapper
import random
...
class Cola(pl.LightningModule):
    def __init__(self, p=0.1, dim_fea=1280, dim_hidden=1280, dim_out=512, encoder="efficientnet", max_len=251,
                 out_emb=2048):
        super().__init__()
    ...
    def extract_feature(self, x, dim=1280):   # siam: this part is used in feature extractor
...
class ColaMD(pl.LightningModule):
    def __init__(self, p=0.1, dim_fea=1280, dim_hidden=1280, dim_out=512, encoder="efficientnet", batch_size=128,
                 num_batch=[258.0, 288, 4, 51, 75, 146, 138], out_emb=2048, max_len=251):
        super().__init__()
        self.save_hyperparameters()
